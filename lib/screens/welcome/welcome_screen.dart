...
// import 'package:shared_preferences/shared_preferences.dart'; //ไม้ได้ใช้แล้วใช้แบบ re-use แทน
...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  void _onIntroEnd(context) async {
    ...
    // รูปแบบใช้ get ไม่ได้เขียนแบบ re-use
    // SharedPreferences prefs = await SharedPreferences.getInstance();
    // prefs.setBool('welcomeStatus', true);

    // เขียนแบบ re-use
    await Utility.setSharedPreference('welcomStatus', true);
